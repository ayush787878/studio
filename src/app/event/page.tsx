    ...
    <AppShell>
      ...
      <div className="space-y-8 animate-in fade-in-0 duration-500">
        <div className="text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Join our event, get creative, and win cash prizes! Make sure you're following our official account to stay updated.</p>
        ...
        <Card className="bg-gradient-to-br from-purple-500 via-pink-500 to-red-500 text-white border-0 shadow-2xl animate-in slide-in-from-bottom-5 duration-700">
          ...
          <CardContent className="text-center">
            <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm">
              ...
              <p className="text-5xl md:text-6xl font-bold">200,000 Views!</p>
              <p className="text-2xl font-bold mt-4 animate-pulse">$5 - $20 USD</p>
            </div>
